...
useEffect(() => {
    const fetchRooms = async () => {
        if (hostel) { // Check if hostel type is determined
            ...
            // If no hostel type is determined, clear the available rooms
            setAvailableRooms([]);
        }
    };

    fetchRooms();
}, [hostel]); // Dependency on `hostel` instead of `userData.hostel`
                    ...
                    <>
                        ...
                        <div className="mb-4">
                            ...
                            {/* <input
                                ...
                                required
                            /> */}
                            <select name="hostel" value={userData.hostel} onChange={handleInputChange}
                             className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
